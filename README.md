# Capstone-Projects-by-Python
> I was learning Python recently on Udemy. This is a list from the chapter Capstone. I will try to finish those small projects one-by-one

## Numbers
---------

* [x] **Find PI to the Nth Digit** - Enter a number and have the program generate &pi; (pi) up to that many decimal places. Keep a limit to how far the program will go.
